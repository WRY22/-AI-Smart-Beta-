globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/page-Vez1LRTI.js","assets/layout-segment-context-BNhhI_4N.js"];
...
function getDraftSecret() {
	return "9752e52f-5782-4328-9225-694520efd01f";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "d06e0d3c-419b-4d22-b7d3-cdf73894b32c";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "d06e0d3c-419b-4d22-b7d3-cdf73894b32c") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "d06e0d3c-419b-4d22-b7d3-cdf73894b32c",
		rootBoundaryId
	});
}
/**
